...
disp('please undock command window')
pause(3)
clc
%running ascII funciton which prints out the ascii art into the command
%window aswell as calling Sound Effects funciton to play intro music
ascII2('ASCII2.png',6)

% ascIItest("win.png", 23, 23, 2, 2, 0.1);
...
RulesYN=input("\nIf you would like to read the rules for the game type 1, if not press enter:");
...
pause(2)
        ...
        %calling ascII function to display you lose and play lose sound effect
%from sound effects function
ascII2('lose.png',3)
